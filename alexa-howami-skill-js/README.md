# Overview
A simple [AWS Lambda](http://aws.amazon.com/lambda) function that shows using the Eyeris EmoVu Web API to perform a simple Alexa Skill, "How am I?".  Alexa will answer based on your facial expression.

## Concepts
This focuses on communication with the Eyeris EmoVu Web API, providing a glimpse into the world of machine learning and face analytics in the context of Amazon's amazing Alexa platform.
...
TODO: Cleanup this boilerplate to clarify the setup

1. Go to the AWS Console and click on the Lambda link. Note: ensure you are in us-east or you won't be able to use Alexa with Lambda.
2. Click on the Create a Lambda Function or Get Started Now button.
3. Skip the blueprint
4. Name the Lambda Function "alexa-howami-skill-js".
...
TODO: Cleanup this boilerplate to clarify setup steps.
